...
var variables = exports.variables = _extends({}, commonTheme, {
...
var getHoverColor = exports.getHoverColor = function getHoverColor(color) {
...
var getWithOpacity = exports.getWithOpacity = function getWithOpacity(color, opacity) {
  if (!color) return null;
...
var getElementStylesBySize = exports.getElementStylesBySize = function getElementStylesBySize(props, type, field) {
  var sm = props.sm,
      lg = props.lg;
...
var getColor = exports.getColor = function getColor(props, type) {
