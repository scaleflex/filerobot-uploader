...
[![Release](https://img.shields.io/badge/release-v2.3.0-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-uploader/2.3.0/filerobot-uploader.min.js"></script>
```
...
* `customFields`: array [{ name, metaKey, type }] - custom properties for an image. Where **name** - name of fields,
**metaKey** - key/id of the field, **type** - type of field: 'text', 'textarea'
