...
[![Release](https://img.shields.io/badge/release-v1.6.5-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```
<script src="https://cdn.scaleflex.it/filerobot/uploader/1.6.4/main.min.js"></script>
```
