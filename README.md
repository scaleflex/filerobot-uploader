...
[![Release](https://img.shields.io/badge/release-v2.12.1-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-uploader/2.12.1/filerobot-uploader.min.js"></script>
```
