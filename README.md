...
[![Release](https://img.shields.io/badge/release-v1.3.6-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```
<script src="https://scaleflex.airstore.io/filerobot/uploader/1.3.6/main.min.js"></script>
```
