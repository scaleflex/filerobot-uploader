...
[![Release](https://img.shields.io/badge/release-v2.15.11-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-uploader/2.15.11/filerobot-uploader.min.js"></script>
```
