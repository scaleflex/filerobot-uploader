...
[![Release](https://img.shields.io/badge/release-v1.5.0-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```
<script src="https://cdn.scaleflex.it/filerobot/uploader/1.5.0/main.min.js"></script>
```
