...
[![Release](https://img.shields.io/badge/release-v2.12.0-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-uploader/2.12.0/filerobot-uploader.min.js"></script>
```
