...
[![Release](https://img.shields.io/badge/release-v2.14.3-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```html
<script src="https://cdn.scaleflex.it/plugins/filerobot-uploader/2.14.11/filerobot-uploader.min.js"></script>
```
