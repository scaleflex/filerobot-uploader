...
[![Release](https://img.shields.io/badge/release-v1.4.7-blue.svg)](https://github.com/scaleflex/filerobot-uploader/releases)
...
```
<script src="https://cdn.scaleflex.it/filerobot/uploader/1.4.7/main.min.js"></script>
```
